...
import { formatDateToMonthYear, compareByDate, isUnixEpoch } from "./Util.js"
  ...
  return (
    <>
      {autobiography.map((person, piter) => (
        ...
        <div className="container mx-auto bg-white-200 p-8 m-10 mb-2 min-h-48 min-w-160 w-auto max-w-screen-lg" key="person_container">
          <div className="flex flex-row gap-x-4 w-full" key={person.name + "_container"}>
            <div className="flex-initial h-48 w-48 min-w-[128px] min-h-[128px] flex-shrink-0" key="person_image_container">
      ...
      <div className="container mx-auto bg-white-200 p-8 pb-0 pt-0 min-h-48 min-w-128 max-w-screen-lg relative" key="education_items_container">
        <h1 className="text-3xl font-semibold text-gray-700 dark:text-white" key="edu_title">Education:</h1>
          {educationItems ? (
      ...
      <h1 className="text-3xl font-semibold text-gray-700 dark:text-white" key="exp_title">Work Experience:</h1>
