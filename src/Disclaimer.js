export default function Disclaimer() {
    return (
    <>
        <div class="flex justify-center md:justify-between p-2 animate-load mt-8 mb-8 ml-5 mr-5">
            <div class="w-full md:w-11/12 lg:w-11/12 xl:w-11/12">

                <h1 class="text-3xl font-bold mt-8 mb-8">Disclaimer</h1>
                <h2 class="text-xl font-semibold mb-4">In English</h2>
                <h6 class="text-sm font-semibold mt-8 mb-4">1. Limitation of liability for internal content</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h6 class="text-sm font-semibold mt-8 mb-4">2. Limitation of liability for external links</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h6 class="text-sm font-semibold mt-8 mb-4">3. Copyright</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h6 class="text-sm font-semibold mt-8 mb-4">4. Data protection</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h6 class="text-sm font-semibold mt-8 mb-4">5. Cookies</h6>
                <p class="mb-4 ml-4 indent-8">
                    This website does not utilize any cookies.
                </p>

                <h2 class="text-xl font-semibold mt-4">Auf Deutsch</h2>
                <h6 class="text-sm font-semibold mt-8 mb-4">1. Haftungsbeschränkung</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h6 class="text-sm font-semibold mt-8 mb-4">2. Externe Links</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h6 class="text-sm font-semibold mt-8 mb-4">3. Urheberrecht/Leistungsschutzrecht</h6>
                <p class="mb-4 ml-4 indent-8">
                    Die auf dieser Webseite veröffentlichten Inhalte, Werke und bereitgestellten Informationen unterliegen dem deutschen Urheberrecht und Leistungsschutzrecht. Jede Art der Vervielfältigung, Bearbeitung, Verbreitung, Einspeicherung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedarf der vorherigen schriftlichen Zustimmung des jeweiligen Rechteinhabers. Das unerlaubte Kopieren/Speichern der bereitgestellten Informationen auf diesen Webseiten ist nicht gestattet und strafbar.
                </p>
                <h6 class="text-sm font-semibold mt-8 mb-4">4. Datenschutz</h6>
                <p class="mb-4 ml-4 indent-8">
                ...
                <h1 class="text-3xl font-bold mt-16">Imprint / Impressum</h1>
                <p class="mb-4">
                    <h6 class="text-sm font-semibold mt-8 mb-4">Personal Details / Persönliche Angaben</h6>
                    <p className="ml-4">
                        Yakup Koray Budanaz <br />
                        Clemensstr. 118/B07, 80796, München <br /> <br />
                    </p>
                    <h6 class="text-sm font-semibold mt-4 mb-4">Contact Information / Kontaktdaten</h6>
                    <p className="ml-4">
                        +49 163 140 22 79 <br />
