...
export default function Disclaimer() {
    return (
        <>
            <div className="flex justify-center md:justify-between p-2 animate-load mt-8 mb-8 ml-5 mr-5">
                <div className="w-full md:w-11/12 lg:w-11/12 xl:w-11/12">

                    <h1 className="text-3xl font-bold mt-8 mb-8">Disclaimer</h1>
                    <h2 className="text-xl font-semibold mb-4">In English</h2>
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">1. Limitation of liability for internal content</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                    ...
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">2. Limitation of liability for external links</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                        Our website contains links to the websites of third parties (“external links”). As the content of these websites is not under our control, we cannot assume any liability for such external content. In all cases, the provider of information on the linked websites is liable for the content and accuracy of the information provided. At the point in time when the links were placed, no infringements of the law were recognizable to us. As soon as an infringement of the law becomes known to us, we will immediately remove the link in question.
                    </p>
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">3. Copyright</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                    ...
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">4. Data protection</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                    ...
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">5. Cookies</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                        This website does not utilize any cookies.
                    </p>

                    <h2 className="text-xl font-semibold mt-4">Auf Deutsch</h2>
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">1. Haftungsbeschränkung</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                    ...
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">2. Externe Links</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                    ...
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">3. Urheberrecht/Leistungsschutzrecht</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                        Die auf dieser Webseite veröffentlichten Inhalte, Werke und bereitgestellten Informationen unterliegen dem deutschen Urheberrecht und Leistungsschutzrecht. Jede Art der Vervielfältigung, Bearbeitung, Verbreitung, Einspeicherung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedarf der vorherigen schriftlichen Zustimmung des jeweiligen Rechteinhabers. Das unerlaubte Kopieren/Speichern der bereitgestellten Informationen auf diesen Webseiten ist nicht gestattet und strafbar.
                    </p>
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">4. Datenschutz</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                    ...
                    <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">5. Cookies</h6>
                    <p className="mb-4 ml-4 indent-8 text-justify">
                        Diese Webseite benutzt keine Art von cookies
                    </p>
                    <h1 className="text-3xl font-bold mt-16">Imprint / Impressum</h1>
                    <p className="mb-4">
                        <h6 className="text-sm font-semibold mt-8 mb-4 dark:text-gray-400">Personal Details / Persönliche Angaben</h6>
                        <p className="ml-4">
                            Yakup Koray Budanaz <br />
                            Clemensstr. 118/B07, 80796, München <br /> <br />
                        </p>
                        <h6 className="text-sm font-semibold mt-4 mb-4 dark:text-gray-400">Contact Information / Kontaktdaten</h6>
                        <p className="ml-4">
                            +49 163 140 22 79 <br />
                            budanaz.yakup@gmail.com
                        </p>
                    </p>
                </div>
            </div>
